...
- Don't generate characters that a user could not type on a standard keyboard like fancy arrows in documentation or your messages. It is OK to use it in code when asked for without workarounds such as for a symbol in the TUI.
